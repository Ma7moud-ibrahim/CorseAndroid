...
public class MainActivity extends AppCompatActivity {
    ...
    private void darkMode(){
        TextView buttonDarkMode = findViewById(R.id.switchDarkMode);

        buttonDarkMode.setOnClickListener(v -> {
            Toast.makeText(MainActivity.this, "Dark Mode Button Clicked", Toast.LENGTH_SHORT).show();
        });
    }
        ...
        textView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    Toast.makeText(MainActivity.this, "Sorry, no email client found!", Toast.LENGTH_LONG).show();
                }
            }
        });
