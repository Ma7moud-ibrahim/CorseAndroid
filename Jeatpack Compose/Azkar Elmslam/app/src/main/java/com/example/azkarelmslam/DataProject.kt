...
data class DataAskar(
    val text: String,
    val buttonShare: String,
    val repeat: String
)
/*
val listGenreAskar = listOf(
    DataProject("Askar 1", Icons.Default.Face, Color.Red),
    DataProject("Askar 2", Icons.Default.Face, Color.Blue),
    DataProject("Askar 3", Icons.Default.Face, Color.Green)
)
