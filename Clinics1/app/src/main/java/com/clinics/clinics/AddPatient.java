...
public class AddPatient extends AppCompatActivity {
    ...
    private AutoCompleteTextView editTextDoctorName;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<>(this, android.R.layout.simple_dropdown_item_1line, doctorNames);

        // Apply the adapter to the AutoCompleteTextView
        editTextDoctorName.setAdapter(adapter);
