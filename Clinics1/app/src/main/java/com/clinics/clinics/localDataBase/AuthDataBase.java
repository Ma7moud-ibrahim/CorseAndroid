...
public class AuthDataBase extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("create table add_patient (id integer primary key autoincrement, patient_name text,doctor_name text, phone_number text, gender text, date_of_birth text)");
